...
const CRM = () => {
  ...
  return (
    <>
      <div className="mb-4 sm:mb-6 flex flex-col gap-3 sm:gap-4 sm:flex-row sm:items-center sm:justify-between">
        <div className="min-w-0">
          <div className="flex items-center gap-2 flex-wrap">
            <h2 className="text-xl sm:text-2xl font-bold text-slate-900 dark:text-white">CRM</h2>
            <button
              type="button"
        ...
        <button
          ...
          className="inline-flex items-center gap-2 rounded-xl border border-indigo-200 bg-indigo-50 px-3 py-2 sm:px-4 sm:py-2.5 text-xs sm:text-sm font-semibold text-indigo-600 transition-all hover:bg-indigo-100 dark:border-indigo-800 dark:bg-indigo-950/50 dark:text-indigo-400 dark:hover:bg-indigo-900/30 w-full sm:w-auto justify-center"
        >
      ...
      {/* Tabs */}
      <div className="mb-4 sm:mb-6 flex gap-1 sm:gap-2 rounded-xl border border-slate-200 bg-white p-1 dark:border-slate-800 dark:bg-slate-900">
        {TABS.map(({ id, label, icon: Icon }) => (
          <button
            key={id}
            onClick={() => setActiveTab(id)}
            className={`flex flex-1 items-center justify-center gap-1 sm:gap-2 rounded-lg px-2 py-2.5 sm:px-4 sm:py-3 text-xs sm:text-sm font-semibold transition-all min-w-0 ${
              activeTab === id
